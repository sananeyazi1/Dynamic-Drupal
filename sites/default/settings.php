 ...
 * @endcode
 */
$settings['hash_salt'] = 'M8qLSsr5LNco2_XR3Eed5GWbuhRb52GnpvGM8G0wDoqatj8waGUHKDbi6Hud6qDMsZFDojme2w';
 ...
 */
 //$settings['file_public_base_url'] = 'https://mytestdemostorage.blob.core.windows.net/demoblobstoragecontainer';
...
// $settings['file_public_path'] = 'azure://public';
//  $settings['file_public_path'] = 'sites/default/files/demofileshare';
$settings['file_public_path'] = 'sites/default/files';
//$settings['file_public_path'] = '//mytestdemostorage@mytestdemostorage.file.core.windows.net/demofileshare ';
...
$settings['config_sync_directory'] = 'sites/default/files/config_rkNQN_jfeI9P395BZVkg0fAX2TLKIEsHlyr__q1yWSDMaDnV6utoNjFVEd_pWWCoi206rOlAKw/sync';
...
$schemes = [
  'azure' => [
    'driver' => 'azure',
    'config' => [
      'name' => 'mytestdemostorage',
      'key' => 'Uq4zsEyJB+GDSsFCDUOxvozI2ANheN/wU6AIYHJQHwzWuA5Mm+Ff4E61z269Okq0t3F9ob/KQ4rr+AStLAIZbA==',
      'container' => 'demoblobstoragecontainer',
      'endpointSuffix' => 'DefaultEndpointsProtocol=https;AccountName=mytestdemostorage;AccountKey=Uq4zsEyJB+GDSsFCDUOxvozI2ANheN/wU6AIYHJQHwzWuA5Mm+Ff4E61z269Okq0t3F9ob/KQ4rr+AStLAIZbA==;EndpointSuffix=core.windows.net',
      'protocol' => 'https',
    ],
...
//   'account_name' => 'mytestdemostorage',
//   'account_key' => 'Uq4zsEyJB+GDSsFCDUOxvozI2ANheN/wU6AIYHJQHwzWuA5Mm+Ff4E61z269Okq0t3F9ob/KQ4rr+AStLAIZbA==',
//   'container' => 'demoblobstoragecontainer',
//   'endpoint_suffix' => 'DefaultEndpointsProtocol=https;AccountName=mytestdemostorage;AccountKey=Uq4zsEyJB+GDSsFCDUOxvozI2ANheN/wU6AIYHJQHwzWuA5Mm+Ff4E61z269Okq0t3F9ob/KQ4rr+AStLAIZbA==;EndpointSuffix=core.windows.net',
// ];

// $config['system.file']['default_scheme'] = 'azure';