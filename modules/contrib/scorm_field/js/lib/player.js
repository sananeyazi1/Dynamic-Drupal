...
;(function($, Drupal, window, undefined) {
   ...
   * @constructor
   */
  var ScormFieldScormUIPlayer = function(element) {
    this.el = element;
    this.$el = $(element);
  ...
  ScormFieldScormUIPlayer.PATH_PATTERN = 'scorm-field-scorm/player/sco/%sco_id';

  /**
   * Initialize the player.
   */
   ScormFieldScormUIPlayer.prototype.init = function() {
    this.initNavigation();
    this.initEvents();
  }
   ...
   */
   ScormFieldScormUIPlayer.prototype.initNavigation = function() {
    // Tree navigation.
   ...
   */
   ScormFieldScormUIPlayer.prototype.registerTreeClick = function() {
    var player = this;
   ...
   * her to.
   */
   ScormFieldScormUIPlayer.prototype.handleTreeControlModes = function() {
    var player = this;
   ...
   */
   ScormFieldScormUIPlayer.prototype.initEvents = function() {
    var player = this;
   ...
   * @param scoID
   */
   ScormFieldScormUIPlayer.prototype.launch = function(scoID, scoObjectives) {
    // Set the SCO ID as an attribute on the iframe.
    this.$iframe.data('sco-id', scoID);

    // Load the SCO.
    this.iframe.dataset.scoId = scoID;
    this.iframe.src = Drupal.settings.basePath + ScormFieldScormUIPlayer.PATH_PATTERN.replace('%sco_id', scoID);
  ...
  // Export.
  window.ScormFieldScormUIPlayer = ScormFieldScormUIPlayer;
